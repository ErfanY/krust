...
impl Keymap {
    ...
    fn binding(&self, action: Action) -> &Binding {
        match action {
            ...
            Action::ToggleHelmSecrets => &self.toggle_helm_secrets,
...
impl Default for Keymap {
    fn default() -> Self {
        Self {
            ...
            toggle_helm_secrets: Binding::from_str("shift+h").expect("valid default"),
...
impl TryFrom<RawKeymap> for Keymap {
    ...
    fn try_from(raw: RawKeymap) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            toggle_helm_secrets: Binding::from_str(&raw.toggle_helm_secrets)?,
...
impl Default for RawKeymap {
    fn default() -> Self {
        Self {
            ...
            toggle_helm_secrets: "shift+h".to_string(),
...
impl fmt::Display for Action {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let s = match self {
            ...
            Action::ToggleHelmSecrets => "toggle_helm_secrets",
